...
const DEFAULT_EXERCISES: Omit<Exercise, 'id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  { name: "Incline Dumbbell Press", type: "reps", equipment: "dumbbell", primaryMuscles: [{ muscle: "chest", weight: 0.60 }], secondaryMuscles: [ { muscle: "shoulders", weight: 0.25 }, { muscle: "triceps", weight: 0.15 } ], movementPatterns: ["push"], mediaUrl: "/exercises/incline-dumbbell-press.gif" },
  ...
  { name: "Seated Cable Row", type: "reps", equipment: "cable", primaryMuscles: [{ muscle: "back", weight: 0.70 }], secondaryMuscles: [ { muscle: "biceps", weight: 0.20 }, { muscle: "forearms", weight: 0.10 } ], movementPatterns: ["pull"], mediaUrl: "/exercises/low-row-machine.gif" },
  ...
  { name: "Workout 7", type: "reps", equipment: "other", primaryMuscles: [{ muscle: "back", weight: 0.80 }], secondaryMuscles: [{ muscle: "biceps", weight: 0.20 }], movementPatterns: ["pull"], mediaUrl: "/exercises/back-workout-8.webp" },
  { name: "Workout 8", type: "reps", equipment: "other", primaryMuscles: [{ muscle: "back", weight: 0.80 }], secondaryMuscles: [{ muscle: "biceps", weight: 0.20 }], movementPatterns: ["pull"], mediaUrl: "/exercises/back-workout-9.webp" },
  { name: "Workout 9", type: "reps", equipment: "other", primaryMuscles: [{ muscle: "back", weight: 0.80 }], secondaryMuscles: [{ muscle: "biceps", weight: 0.20 }], movementPatterns: ["pull"], mediaUrl: "/exercises/back-workout-10.webp" },
  { name: "Workout 10", type: "reps", equipment: "other", primaryMuscles: [{ muscle: "back", weight: 0.80 }], secondaryMuscles: [{ muscle: "biceps", weight: 0.20 }], movementPatterns: ["pull"], mediaUrl: "/exercises/back-workout-11.webp" },
  { name: "Dumbbell Row (Alt)", type: "reps", equipment: "dumbbell", primaryMuscles: [{ muscle: "back", weight: 0.70 }], secondaryMuscles: [{ muscle: "biceps", weight: 0.20 }, { muscle: "forearms", weight: 0.10 }], movementPatterns: ["pull"], mediaUrl: "/exercises/dumbbell-row-2.gif" },
  { name: "Workout 11", type: "reps", equipment: "other", primaryMuscles: [{ muscle: "back", weight: 0.80 }], secondaryMuscles: [{ muscle: "biceps", weight: 0.20 }], movementPatterns: ["pull"], mediaUrl: "/exercises/back-workout-12.webp" },
  { name: "Workout 12", type: "reps", equipment: "other", primaryMuscles: [{ muscle: "back", weight: 0.80 }], secondaryMuscles: [{ muscle: "biceps", weight: 0.20 }], movementPatterns: ["pull"], mediaUrl: "/exercises/back-workout-13.webp" },
  // Chest exercises with media
  { name: "Machine Chest Fly", type: "reps", equipment: "machine", primaryMuscles: [{ muscle: "chest", weight: 0.85 }], secondaryMuscles: [{ muscle: "shoulders", weight: 0.15 }], movementPatterns: ["push"], mediaUrl: "/exercises/machine-chest-fly.webp" },
  { name: "Incline Barbell Bench Press", type: "reps", equipment: "barbell", primaryMuscles: [{ muscle: "chest", weight: 0.60 }], secondaryMuscles: [{ muscle: "shoulders", weight: 0.25 }, { muscle: "triceps", weight: 0.15 }], movementPatterns: ["push"], mediaUrl: "/exercises/incline-bench-press.webp" },
  { name: "Dumbbell Pullover", type: "reps", equipment: "dumbbell", primaryMuscles: [{ muscle: "chest", weight: 0.50 }, { muscle: "back", weight: 0.30 }], secondaryMuscles: [{ muscle: "triceps", weight: 0.20 }], movementPatterns: ["pull"], mediaUrl: "/exercises/dumbbell-pullover.webp" },
  { name: "Dumbbell Chest Press", type: "reps", equipment: "dumbbell", primaryMuscles: [{ muscle: "chest", weight: 0.65 }, { muscle: "triceps", weight: 0.20 }], secondaryMuscles: [{ muscle: "shoulders", weight: 0.15 }], movementPatterns: ["push"], mediaUrl: "/exercises/dumbbell-chest-press.webp" },
  { name: "Dumbbell Chest Fly", type: "reps", equipment: "dumbbell", primaryMuscles: [{ muscle: "chest", weight: 0.85 }], secondaryMuscles: [{ muscle: "shoulders", weight: 0.15 }], movementPatterns: ["push"], mediaUrl: "/exercises/dumbbell-chest-fly.webp" },
  { name: "Cable Chest Press", type: "reps", equipment: "cable", primaryMuscles: [{ muscle: "chest", weight: 0.65 }], secondaryMuscles: [{ muscle: "triceps", weight: 0.20 }, { muscle: "shoulders", weight: 0.15 }], movementPatterns: ["push"], mediaUrl: "/exercises/cable-chest-press.webp" },
  { name: "Dips", type: "reps", equipment: "bodyweight", primaryMuscles: [{ muscle: "chest", weight: 0.45 }, { muscle: "triceps", weight: 0.40 }], secondaryMuscles: [{ muscle: "shoulders", weight: 0.15 }], movementPatterns: ["push"], mediaUrl: "/exercises/dips.webp" },
];
